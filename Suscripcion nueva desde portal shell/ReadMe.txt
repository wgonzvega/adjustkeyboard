...
5- Usar nombre de la suscripcion para el Management Group nuevo
...
9- Crear Automation Account aut-[account name]-runbook1 en un RG nuevo rg-[account name]automation-[##]
...
16- Mover la suscripcion del Management Group Tenant Root al Management Group nuevo creado bajo el Evertec LLC Management Group
